...
class ActionDataPreprocessor(BaseDataPreprocessor):
    ...
    def forward(self,
        ...
        # if isinstance(data, dict):
        #     result = self.forward_onesample(data, training)
        # elif isinstance(data, tuple):
        #     outputs = []
        #     for data_sample in data:
        #         output = self.forward_onesample(data_sample, training)
        ...
        # torch.cuda.synchronize()
        # end = time.time()
        # print(f'datapreprocessor forward 耗时：{end-start}')
        # return result
    ...
    def forward_onesample(self, data: dict, training: bool = False) -> dict:
        ...
        # torch.cuda.synchronize()
        # end = time.time()
        # print(f'cast_data 耗时：{end-start}')
        # start = end
        ...
        # end = time.time()
        # print(f'stack_batch 耗时：{end-start}')
        # start = end
        ...
        # torch.cuda.synchronize()
        # end = time.time()
        # print(f'normalize 耗时：{end-start}')
