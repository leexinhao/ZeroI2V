...
model = dict(
    ...
    backbone=dict(
        type='ViT_Zero_CLIP',
        pretrained="/mnt/petrelfs/lixinhao/lxh_exp/pretrained_models/CLIP",
...
data_root = 'your_parth/UCF101/frames'
data_root_val = data_root
ann_file_train = f'your_path/ucf101_train_split_{split}_rawframes.txt'
ann_file_val = f'your_path/ucf101_val_split_{split}_rawframes.txt'
ann_file_test = f'your_path/ucf101_val_split_{split}_rawframes.txt'
