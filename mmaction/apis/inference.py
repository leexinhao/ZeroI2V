...
def init_recognizer_wo_cp(config: Union[str, Path, mmengine.Config],
...
def inference_recognizer_val(model: nn.Module,
                         video: Union[str, dict],
                         val_pipeline: Optional[Compose] = None
                         ) -> ActionDataSample:
    ...
    Args:
        ...
        val_pipeline (:obj:`Compose`, optional): The val pipeline.
    ...
    if val_pipeline is None:
        cfg = model.cfg
        val_pipeline_cfg = cfg.val_pipeline
